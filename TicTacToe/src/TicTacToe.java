...
public class TicTacToe {
	...
	private void initialize() {
		...
		btn1.setFont(new Font("Segoe UI", Font.BOLD, 40));
		...
		btn2.setFont(new Font("Segoe UI", Font.BOLD, 40));
		...
		btn3.setFont(new Font("Segoe UI", Font.BOLD, 40));
		...
		xCount.setFont(new Font("Segoe UI", Font.BOLD, 30));
		...
		btn4.setFont(new Font("Segoe UI", Font.BOLD, 40));
		...
		btn5.setFont(new Font("Segoe UI", Font.BOLD, 40));
		...
		btn6.setFont(new Font("Segoe UI", Font.BOLD, 40));
		...
		oCount.setText("0");
		oCount.setFont(new Font("Segoe UI", Font.BOLD, 30));
		...
		btn7.setFont(new Font("Segoe UI", Font.BOLD, 40));
		...
		btn8.setFont(new Font("Segoe UI", Font.BOLD, 40));
		...
		btn9.setFont(new Font("Segoe UI", Font.BOLD, 40));
		panel_13.add(btn9);
		...
		btnReset.setFont(new Font("Segoe UI", Font.BOLD | Font.ITALIC, 20));
		...
		btnExit.setFont(new Font("Segoe UI", Font.BOLD | Font.ITALIC, 20));
